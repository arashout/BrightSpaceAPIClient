...
var CommandBarComponent = (function () {
    function CommandBarComponent(brightspaceService) {
        this.brightspaceService = brightspaceService;
...
CommandBarComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__shared_brightspace_api_service__["a" /* BrightspaceAPIService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__shared_brightspace_api_service__["a" /* BrightspaceAPIService */]) === "function" && _a || Object])
], CommandBarComponent);
...
var BrightspaceAPIService = (function () {
    ...
    BrightspaceAPIService.prototype.getAPIResultsPromise = function (basePath, apiCommand) {
    ...
    BrightspaceAPIService.prototype.getAPIResults = function (basePath, apiCommand) {
        var _this = this;
        this.getAPIResultsPromise(basePath, apiCommand).then(function (response) {
